...
<article class="page-container">
	<form action="<%=request.getContextPath()%>/department/update.do" method="post" class="form form-horizontal" id="form-admin-department-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${department.departmentCode }" placeholder="" id="departmentCode" name="departmentCode">
			</div>
		</div>
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
				<button type="submit" class="btn btn-success radius" id="admin-department-save" name="admin-department-save"><i class="icon-ok"></i> 确定</button>
			</div>
		</div>
	</form>
</article>

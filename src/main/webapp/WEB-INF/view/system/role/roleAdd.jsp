...
<article class="page-container">
	<form action="<%=request.getContextPath()%>/role/add.do" method="post" class="form form-horizontal" id="form-admin-role-add">
		<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">角色编号：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" placeholder="" id="roleCode" name="roleCode">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">角色类型：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" placeholder="" id="roleType" name="roleType">
			</div>
		</div>
		<div class="row cl">
